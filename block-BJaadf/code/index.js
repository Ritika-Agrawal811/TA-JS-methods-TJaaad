...
lowercaseFruit = fruits.map((fruits) => fruits.toLowerCase());

// Convert all fruits name into uppercase and store in new array named uppercaseFruits
uppercaseFruit = fruits.map((fruits) => fruits.toUpperCase());
...
console.log(numbersThree.findIndex((value) => value == 10));
...
let newFruits = fruits.map((fruit) => fruit.toUpperCase()).join("-");
console.log(newFruits);

// Join all fruits with '&', convert to lowercase and log it
let newFruits1 = fruits.map((fruit) => fruit.toLowerCase()).join("&");
